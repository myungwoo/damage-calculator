...
const DEFAULT_STATE = {
  monster: {
    ...
    strongestPhysicalAttack: monsterPresets[0].strongestPhysicalAttack,
...
const resolveMonsterSelection = (savedMonster: Monster) => {
  ...
  return {
    monster: {
      ...
      strongestPhysicalAttack: matchingPreset?.strongestPhysicalAttack,
      ...
      if (selectedPreset) {
        setState((prev) => ({
          ...
          monster: {
            ...
            strongestPhysicalAttack: selectedPreset.strongestPhysicalAttack,
