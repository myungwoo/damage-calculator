            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 text-xs leading-relaxed text-muted">
                  ...
                  <strong>
                    둘째 줄의 데미지를 정한 난수가 셋째 줄의 크리티컬 판정에
                    그대로 쓰인다
                  </strong>
                ...
                <p className="mt-1.5 text-xs leading-relaxed text-muted">
                  겹치는 건 <strong>이 한 쌍뿐</strong>이다. 첫째 줄은 데미지도
                  크리티컬도 독립이고, 첫째-둘째를 포함한 나머지 짝은 실측에서
                  반례가 나와 배제됐다. 계산기도 둘째-셋째만 묶어서 계산한다.
                  (줄 번호는 실측을 기록한 순서 기준이고, 어느 줄이 실제 첫
                  타격인지는 확정되지 않았다. 세 줄을 더할 뿐이라 결과는 같다.)
                </p>
                <p className="mt-1.5 text-xs leading-relaxed text-muted">
                  크리티컬 판정 기준이 크리티컬 확률과 같아서, 둘째 줄의 데미지
                  난수가 아래쪽 구간(= 크리티컬 확률만큼)에 들어가면 셋째 줄은
                  크리티컬, 아니면 일반이 된다. 세 줄을 전부 독립으로 볼 때와
                  평균은 같고, 시전 1회 총합의 표준편차만 약 15% 줄어든다.
                </p>
                <p className="mt-1.5 text-xs leading-relaxed text-muted">
